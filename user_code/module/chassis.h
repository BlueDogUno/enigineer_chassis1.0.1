...
//底盘运动过程最大平移速度
#define NORMAL_MAX_CHASSIS_SPEED_Y  3.0f //1.5
//底盘运动过程最大旋转速度
#define NORMAL_MAX_CHASSIS_SPEED_Z 8.0f

//原地旋转小陀螺下Z轴转速
#define TOP_WZ_ANGLE_STAND 2.5f
//移动状态下小陀螺转速
#define TOP_WZ_ANGLE_MOVE 1.5f
...
//底盘电机速度环PID
#define MOTIVE_MOTOR_SPEED_PID_KP 10000.0f
#define MOTIVE_MOTOR_SPEED_PID_KI 0.1f
#define MOTIVE_MOTOR_SPEED_PID_KD 100.0f
